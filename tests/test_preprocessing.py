...
from src.data_loading.preprocessing.neighborhood_statistics import preprocess_neighborhood_details
    ...
    data = [
        {
            ...
            "outdoor_features": {"Ligging": "In woonwijk", "Tuin": None, "Achtertuin": None, "Ligging tuin": None},
            "cadastral_parcels": [{"parcel": "Parcel 1"}, {"parcel": "Parcel 2"}],
            "ownership_situations": [{"ownership_type": "Freehold"}],
            "charges": ["Servicekosten € 50", "Gemeentelijke belastingen € 100"],
